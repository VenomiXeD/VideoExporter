...
namespace VideoViewer
{
    public class VideoExporterContextMenu : DataExplorerContextMenuExtension
    {
        ...
        public override RelayCommand ContextItemClicked => new RelayCommand(OnContextMenuClicked);
        ...
        private async void OnContextMenuClicked(object obj)
        {
            ...
            string outputFileBaseMp4 = Path.Combine(AppContext.BaseDirectory, "exported", $"{App.SelectedAsset.DisplayName}-vid.mp4");
            string outputFileFullMp4 = Path.Combine(AppContext.BaseDirectory, "exported", $"{App.SelectedAsset.DisplayName}-merged.mp4");
            string outputFileAudioWav = Path.Combine(AppContext.BaseDirectory, "exported", $"{App.SelectedAsset.DisplayName}.wav");
            ...
            processStart.Arguments = $"-i \"{inputFile}\" -c:v libx264 -crf 18 -preset slow -c:a aac -b:a 192k \"{outputFileBaseMp4}\"";
